...
// Creates an HTML table in the DOM based on a nine-element JS array.
// Attaches a click listener to each table element.
const boardToHTML = function (inputArray) {
  console.log('creating DOM array')
  // create 3 by 3 JS 2D array
  ...
  for (let row = 0; row < array.length; row++) {
    ...
    for (let col = 0; col < array[row].length; col++) {
      ...
      $(tableData).click(game.onSquareClick)
